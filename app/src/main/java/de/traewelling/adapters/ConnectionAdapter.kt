...
class ConnectionAdapter(val connections: List<Connection>, val onItemClick: (Connection) -> Unit) : RecyclerView.Adapter<ConnectionAdapter.ConnectionViewHolder>() {
    ...
    override fun onBindViewHolder(holder: ConnectionViewHolder, position: Int) {
        ...
        holder.itemView.setOnClickListener {
            onItemClick(connections[position])
        }
    }
