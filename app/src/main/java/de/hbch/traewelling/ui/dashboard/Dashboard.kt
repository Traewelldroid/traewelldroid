...
fun Dashboard(
    ...
    val dashboardViewModel: DashboardFragmentViewModel by viewModel()
    val searchStationCardViewModel: SearchStationCardViewModel by viewModel()
            ...
            items(
                ...
                CheckInCard(
                    ...
                    stationSelected = { station, date ->
                        searchConnectionsAction(station, date)
                    },
